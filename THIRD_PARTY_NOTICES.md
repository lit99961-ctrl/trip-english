...
A small audited manual map supplies catalog-specific proper names and variants when the pinned
source has no usable translated entry. The generated dictionary contains exactly 1,000 entries.
