...
function businessMission(
  ...
  return {
    ...
    exercises: [
      { id: `${id}-reading-main`, type: "reading", phraseId: `${id}-${phrases[0]![0]}`, promptZh: "读短文本，找出谁、什么事和下一步。" },
...
export const businessMissions: readonly Mission[] = [
  businessMission("email-action", "邮件：找到行动项", 4, ["sender", "subject", "deadline", "attachment"], { deadline: "Friday", item: "file" }, [
  ...
  businessMission("internet-headline", "互联网标题：识别变化", 8, ["launch", "update", "problem", "service"], { change: "update", service: "app" }, [
  ...
  businessMission("message-intent", "消息意图：简短回复", 11, ["request", "information", "decision", "urgent"], { urgency: "urgent", reply: "today" }, [
