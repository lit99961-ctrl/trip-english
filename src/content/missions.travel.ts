...
export const travelMissions: readonly Mission[] = [
  ...
  travelMission("italy-high-speed-rail", "意大利高铁", "Rome–Florence–Venice", ["platform", "carriage", "seat", "delay", "departure"], { platform: "9", carriage: "4" }, "Is this train on platform {platform}? Where is carriage {carriage}?", "DEPARTURES: FLORENCE / VENICE — PLATFORM 9", "platform", [
    ...
    ["platform", "Which platform is it?", "是哪个站台？", "find-platform", ["platform", "track"], [["where", "which", "is"], ["platform", "track"]]],
  ...
  travelMission("swiss-mountain-transit", "瑞士山区交通", "Zermatt–Gornergrat–Grindelwald–Lucerne", ["regional train", "cable car", "Grindelwald", "Interlaken", "Lungern", "Lucerne", "Zurich Airport", "weather", "last train"], { destination: "Lucerne", returnTime: "later" }, "Is this for {destination}? Is there a {returnTime} train back?", "TIMETABLE: LUNGERN STOP — LUCERNE — ZURICH AIRPORT", "return", [
  ...
  travelMission("shopping-tax-refund", "购物和退税", "Milan", ["size", "color", "card", "tax-free", "refund"], { size: "medium", color: "blue" }, "Do you have this in {size} and {color}?", "TAX-FREE: PASSPORT REQUIRED FOR REFUND FORM", "size", [
    ["size", "Do you have this in medium?", "这个有中码吗？", "ask-size", ["medium", "size"], [["have"], ["medium"]]],
    ["color", "Do you have it in blue?", "有蓝色的吗？", "ask-color", ["blue", "color"], [["have"], ["blue"]]],
  ...
  travelMission("urgent-help", "紧急求助", "Italy and Switzerland", ["lost", "toilet", "police", "doctor", "pharmacy", "112", "location", "bag"], { place: "the station entrance", help: "a police officer" }, "I am lost at {place}. I need {help}.", "WC / TOILET → EMERGENCY 112", "police", [
